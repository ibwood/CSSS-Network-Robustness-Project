...
if __name__ == "__main__":
	...
	rid = sys.argv[2]
	number_seed = int(sys.argv[3]) # in prefix s#_
	init_growth_num = int(sys.argv[4]) # in prefix ig#_
	#init_mtotal = sys.argv[5] # in prefix imt#_
	init_m_ba_turn = int(sys.argv[5]) # in prefix imbt#_
	#init_p = sys.argv[7] # in prefix ip#_
	init_lambda = float(sys.argv[6]) # in prefix il#_
	attack_type = sys.argv[7] # in prefix at#_
	attack_percent = float(sys.argv[8]) # in prefix ap#_
	growth_num = int(sys.argv[9]) # in prefix gn#_
	mtotal = int(sys.argv[10]) # in prefix mt#_
	m_ba_turn = int(sys.argv[11]) # in prefix mbt#_
	p = float(sys.argv[12]) # in prefix p#_
	lamb = float(sys.argv[13]) # in prefix l#_
	number_of_turns = int(sys.argv[14]) #in prefix nt#_
